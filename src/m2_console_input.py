...
def double_a_float():
    ...
    user_number = int(input('Enter a number NOW! '))
    print('HERE:',2*user_number)
...
def print_an_integer_many_times_on_one_row():
    ...
    new = int(input('Enter a number to be stringededed: '))
    string = ''
    for k in range(new):
        string = string + str(new * 2)
    print(string)
...
def input_it_all():
    ...
    float_num = float(input('Enter a pos. float: '))
    integer = int(input('Enter a pos. integer: '))
    string = input('Enter a string: ')
    float_num = math.sqrt(float_num)
